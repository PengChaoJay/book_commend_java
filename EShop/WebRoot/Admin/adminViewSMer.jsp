...
<html:form action="/Admin/adminMer.do?method=modiSMer" enctype="multipart/form-data" onsubmit="return validateMerForm(this);">
  <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr height="40">
        <td colspan="2" class="itemTitle" align="center">
        	<bean:message key="smer.info.text"/>
        </td>
      </tr>
      <tr height="24">
      ...
      <tr height="24">
        <td colspan="2" align="center">
			<html:link page="/Admin/adminMer.do?method=browseSMer">
